...
screen.fill(white)
clock = pygame.image.load("lab7/images/mickeyWithoutArms.png")
leftArmIMAGE = pygame.image.load("lab7/images/leftarm.png")
rightArmIMAGE = pygame.image.load("lab7/images/rightarm.png")
